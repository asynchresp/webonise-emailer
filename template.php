...
<table cellpadding="0" cellspacing="0" width="600" bgcolor="#84c225" style="font-family:  Arial;border: 1px solid #ccc;">
    ...
    <tr style=" background:#ffffff">
        <td style="padding:0 50px 0 50px; background-repeat:no-repeat; color:#666666">
            <p style="margin-top:0; font-size:14px;line-height: 20px;">
                Hi All,
            </p>
    ...
    <tr>
        <td style="padding: 10px; text-align: center; background: #84C225 none repeat scroll 0% 0%;"><img src="http://emailers.weboapps.com/WelcomeEmailer/img/webonise-logo.png" alt="Webonise Lab"/></td>
    </tr>
</table>
